...
int main() {
	assert(signifix::format(-1e+00, signifix::PROPER) == "-1.000  ");
	assert(signifix::format( 1e+00, signifix::PROPER) ==  "1.000  ");

	assert(signifix::format(-1e+00, signifix::SIGNED) == "-1.000  ");
	assert(signifix::format( 1e+00, signifix::SIGNED) == "+1.000  ");

	assert(signifix::format(-1e+00, signifix::SPACED) == "-1.000  ");
	assert(signifix::format( 1e+00, signifix::SPACED) == " 1.000  ");
}
